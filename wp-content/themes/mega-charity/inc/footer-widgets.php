...
class Mega_Charity_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'mega_charity';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'mega-charity' ), $i ),
...
// Initialize.
$mega_charity_footer_widgets = new Mega_Charity_Footer_Widgets();

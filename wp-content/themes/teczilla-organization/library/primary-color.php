<?php 
function teczilla_organization_inline_css(){
...
$teczilla_theme_color_scheme = get_theme_mod('teczilla_theme_color_scheme','#5e9e95');               
...
add_action( 'wp_enqueue_scripts', 'teczilla_organization_inline_css',20 );
                              ...
                              <h2 class="banner-heading">
                                <?php if ( is_archive() ) {
                                 ...
                                 elseif(is_search()){
                                  ...
                                  echo  esc_html__('Search Results For ', 'teczilla-organization') . ' " ' . get_search_query() . ' "';

                                 }elseif ( is_404() ) {
                                  echo  esc_html__('Nothing Found ', 'teczilla-organization');
                                 }
                                 else{

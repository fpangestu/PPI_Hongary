                ...
                <div class="container">
                    <div class="row y-middle">
                        <div class="col-lg-6">
                            ...
                            <p>
                            <?php
                            printf( __( 'Proudly powered by', 'teczilla-organization' ) );
                            ?>

                            <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'teczilla-organization' ) ); ?>" class="imprint">
                            	
							<?php
                            printf( __( 'WordPress', 'teczilla-organization' ) );
                            ?>
                            </a>
						...
						<ul>
							<li>
							<a href="<?php echo esc_url( admin_url( 'nav-menus.php' ));  ?>"><?php echo esc_html__('Add Footer Menu Here','teczilla-organization'); ?></a>
							</li>
						</ul>
                         <?php
                        }

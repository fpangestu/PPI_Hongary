...
function ngo_charity_donation_custom_styles($custom) {
	...
	wp_add_inline_style( 'ngo-charity-donation-style', $custom );
...
function ngo_charity_donation_sanitize_fonts( $ngo_charity_donation_input ) {
	...
	if ( array_key_exists( $ngo_charity_donation_input, $valid ) ) {

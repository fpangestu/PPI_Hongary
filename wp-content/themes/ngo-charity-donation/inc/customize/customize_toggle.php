 ...
 * @access public
 */
class NGO_Charity_Donation_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'ngo-charity-donation-toggle-control-styles', get_parent_theme_file_uri( 'assets/css/toggle.css' ), false, '1.0.0', 'all' );
	}

...
$blog_section_title = $ft_charity_ngo_options['blog_title'];
$blog_desc = $ft_charity_ngo_options['blog_desc'];
$blog_category = $ft_charity_ngo_options['blog_category'];
$content_length = '100';
if($blog_show) {
                ...
                <?php $recent_query = new WP_Query($args);
                    ...
                    ?>
                        ...
                        global $post;
                            ...
                            $image = wp_get_attachment_image_src($post_thumbnail_id, 'ft-charity-ngo-blog-thumbnail-img');

...
<main id="content">
        ...
        <div <?php if($ngo_charity_donation_i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
          ...
          <div class="carousel-caption text-center text-md-left">
            ...
            <div class="home-btn text-center text-md-left text-sm-left my-4">
              <a class="py-3 px-4" href="<?php the_permalink(); ?>"><?php echo esc_html('DONATE NOW','fundraising-charity-campaign'); ?></a>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 align-self-center">
          ...
          <?php if( get_theme_mod('ngo_charity_donation_volunteer_btn_link') != '' || get_theme_mod('ngo_charity_donation_volunteer_btn_text') != ''){ ?>
            <p class="home-btn mb-md-0 text-center text-md-left"><a href="<?php echo esc_url(get_theme_mod('ngo_charity_donation_volunteer_btn_link','')); ?>"><?php echo esc_html(get_theme_mod('ngo_charity_donation_volunteer_btn_text','')); ?></a></p>
          <?php }?>
        </div>
  ...
  <section id="about-us" class="py-5">
    <div class="container">
      <div class="row">
        <?php
          $fundraising_charity_campaign_mod =  get_theme_mod( 'fundraising_charity_campaign_about_us_settigs');
          if ( 'page-none-selected' != $fundraising_charity_campaign_mod ) {
            $fundraising_charity_campaign_about_page[] = $fundraising_charity_campaign_mod;
          }
          if( !empty($fundraising_charity_campaign_about_page) ) :
          $fundraising_charity_campaign_args = array(
            'post_type' =>array('page'),
            'post__in' => $fundraising_charity_campaign_about_page
          );
          $fundraising_charity_campaign_query = new WP_Query( $fundraising_charity_campaign_args );
          if ( $fundraising_charity_campaign_query->have_posts() ) :
        ?>
        <?php  while ( $fundraising_charity_campaign_query->have_posts() ) : $fundraising_charity_campaign_query->the_post(); ?>
          <div class="col-lg-6 col-md-6 align-self-center">
            <h3><?php the_title();?></h3>
            <h4><?php echo esc_html( get_theme_mod( 'fundraising_charity_campaign_about_us_title','') ); ?></h4>
            <p class="mb-0"><?php the_excerpt(); ?></p>
          </div>
          <div class="col-lg-6 col-md-6 align-self-center">
            <div class="img-box text-center text-md-right">
              <img src="<?php esc_url(the_post_thumbnail_url('full')); ?>"/>
            </div>
          </div>
        <?php endwhile;
